...
import { objectSchema, strictObjectSchema } from "../object";
...
export const AiReviewSchema = strictObjectSchema({
...
const AiChoiceSchema = objectSchema({
...
export const AiProviderResponseSchema = objectSchema({
